...
const validateCouponInput = (payload = {}) => {
    ...
    if (
        ...
        if (Number.isNaN(value)) {
            ...
            errors.minimumPurchase =
                "Minimum purchase must be a valid number.";
...
export const createCoupon = async (req, res) => {
    ...
    try {
        ...
        const alreadyExists =
            await isCouponCodeTaken(data.couponCode);
